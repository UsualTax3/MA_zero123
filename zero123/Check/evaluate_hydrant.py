...
if __name__ == "__main__":
    ...
    for i in range(1, 400):
        pred_img_path = os.path.join(folder, f'output_106_12660_22718_{i}.png')
        tgt_img_path = os.path.join(folder, f'preprocessed_106_12660_22718_{i}.png')
        ...
        if os.path.exists(pred_img_path) and os.path.exists(tgt_img_path):
            ...
            print(f"this: Pair {i}_pred.png and {i}_target.png not found, skipping.")
        else:
