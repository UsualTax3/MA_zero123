...
def load_and_initialize_models():
    global models
    ckpt_path = "/export/scratch/ru89tew/logs/2024-03-09T18-38-15_sd-objaverse-finetune-c_concat-256/checkpoints/epoch=000066.ckpt"
...
def preprocess_image(models, input_im, preprocess):
    ...
    if preprocess:
        ...
        #plt.imshow(input_im)
        #plt.title("Simulated RGBA Image (Resized and Normalized)")
