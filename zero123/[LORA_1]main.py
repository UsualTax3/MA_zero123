...
def freeze_except_attention_layers(model):
    ...
    trainable_layers = [
        ...
        "diffusion_model.input_blocks.1.1.transformer_blocks.0.attn2",
        "diffusion_model.input_blocks.2.1.transformer_blocks.0.attn1",
        "diffusion_model.input_blocks.2.1.transformer_blocks.0.attn2",
        "diffusion_model.input_blocks.4.1.transformer_blocks.0.attn1",
        "diffusion_model.input_blocks.4.1.transformer_blocks.0.attn2",
        "diffusion_model.input_blocks.5.1.transformer_blocks.0.attn1",
        "diffusion_model.input_blocks.5.1.transformer_blocks.0.attn2",
        "diffusion_model.input_blocks.7.1.transformer_blocks.0.attn1",
        "diffusion_model.input_blocks.7.1.transformer_blocks.0.attn2",
        "diffusion_model.input_blocks.8.1.transformer_blocks.0.attn1",
        "diffusion_model.input_blocks.8.1.transformer_blocks.0.attn2",
        "diffusion_model.middle_block.1.transformer_blocks.0.attn1",
        "diffusion_model.middle_block.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.3.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.3.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.4.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.4.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.5.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.5.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.6.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.6.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.7.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.7.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.8.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.8.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.9.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.9.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.10.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.10.1.transformer_blocks.0.attn2",
        "diffusion_model.output_blocks.11.1.transformer_blocks.0.attn1",
        "diffusion_model.output_blocks.11.1.transformer_blocks.0.attn2",
    ]
...
if __name__ == "__main__":
    ...
    try:
        ...
        for name, param in model.named_parameters():
            print(f"{name}: {param.shape} - {'Frozen' if not param.requires_grad else 'Trainable'}")
