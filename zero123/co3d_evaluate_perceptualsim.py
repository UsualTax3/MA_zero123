...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Compute Perceptual Similarity, PSNR, and SSIM for image pairs.")
    ...
    for i in range(1, 900):
        pred_img_path = os.path.join('/export/compvis-nfs/user/rbarlog/zero123/zero123/', 'GT_2/', f'image_{i}.png')
        tgt_img_path = os.path.join('/export/compvis-nfs/user/rbarlog/zero123/zero123/', 'output_2/', f'image_{i}.png')
        ...
        if os.path.exists(pred_img_path) and os.path.exists(tgt_img_path):
            ...
            print(f"this: /export/compvis-nfs/user/rbarlog/zero123/zero123/', 'GT_2/', f'image_{i}.png'")
        else:
            print(f"Warning: Pair {i}_pred.png and {i}_target.png not found, skipping.")

    results = compute_perceptual_similarity_from_list(
        pred_imgs_list, tgt_imgs_list, opts.take_every_other, simple_format=True
    )

    print("Perceptual Similarity:", results["Perceptual similarity"])
