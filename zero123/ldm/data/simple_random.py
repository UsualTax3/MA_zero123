    ...
    def _load_samples(self):
        ...
        for i, (sequence_name, frame_number, image_path) in enumerate(all_samples):
            ...
            if sequence_frame_count[sequence_name] < 12:
                ...
                # Directly modify the element at index i to update the image path
        ...
        # Print which 12 frames are being taken from every sequence
        #for sequence_name, frames in sequence_frame_count.items():
            #print(f"Sequence: {sequence_name}, Frames included: {frames}")
