...
class PerceptualLoss(nn.Module):
    def __init__(self, resize=True):
        ...
        self.resize = resize
        self.feature_layers = {'3', '8', '15', '22'}  # conv1_2, conv2_2, conv3_3, conv4_3 layers
...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        # Decode the reconstructed image if necessary
        if x_reconstructed.shape[1] == 4:  # Assuming 4 channels indicate the need for decoding
