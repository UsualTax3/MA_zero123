...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        here_depth_loss = self.depth_loss(x_reconstructed, x_start)
        weighted_depth_loss = self.depth_weight * here_depth_loss
        loss += weighted_depth_loss
        loss_dict.update({f'{prefix}/depth_loss': here_depth_loss})
