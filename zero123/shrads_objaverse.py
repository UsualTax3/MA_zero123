    ...
    for folder in tqdm(folders, desc="Processing folders"):
        ...
        for i in range(12):
            ...
            if os.path.isfile(png_path) and os.path.isfile(npy_path):
                ...
                sample[f"{i:03}.npy"] = np.load(npy_path).tobytes()
...
#sample = {
#    "__key__": "folder_001",
#    "000.png": binary_content_of_000_png,
#    "000.npy": binary_content_of_000_npy,
#    "001.png": binary_content_of_001_png,
#    "001.npy": binary_content_of_001_npy,
#     ...
#    "011.png": binary_content_of_011_png,
#    "011.npy": binary_content_of_011_npy,
#}    
